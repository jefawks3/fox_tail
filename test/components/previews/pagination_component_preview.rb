...
# @component Flowbite::PaginationComponent
class PaginationComponentPreview < ViewComponent::Preview
  ...
  def playground(page: 6, total: 20, size: :base)
    render Flowbite::PaginationComponent.new(page.to_i, total.to_i, size: size)
  end

  # @!group Size

  def small(page: 6)
    render Flowbite::PaginationComponent.new(page.to_i, 20, size: :sm)
  end

  # @label Base (Default)
  def base(page: 6)
    render Flowbite::PaginationComponent.new(page.to_i, 20, size: :base)
  end
  ...
  def default_actions(page: 6)
    render Flowbite::PaginationComponent.new(page.to_i, 20)
  end

  def first_and_last_actions(page: 6)
    render Flowbite::PaginationComponent.new(page.to_i, 20) do |c|
      c.with_first_button
      c.with_last_button
    end
  end

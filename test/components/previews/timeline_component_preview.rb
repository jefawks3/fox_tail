...
class TimelineComponentPreview < ViewComponent::Preview
  ...
  def dot_indicator
    render FoxTail::TimelineComponent.new do |t|
      t.with_entry do |e|
        e.capture do
          e.concat e.time_tag(Time.zone.today - 10.days, class: "mb-1 text-sm font-normal leading-none text-gray-400 dark:text-gray-500")
      ...
      t.with_entry do |e|
        ...
        e.capture do
          e.concat e.time_tag(Time.zone.today - 20.days, class: "mb-1 text-sm font-normal leading-none text-gray-400 dark:text-gray-500")
          e.concat e.content_tag(:h3, Faker::Books::Lovecraft.tome, class: "text-lg font-semibold text-gray-900 dark:text-white")
          e.concat e.content_tag(:p, Faker::Books::Lovecraft.paragraph, class: "mb-4 text-base font-normal text-gray-500 dark:text-gray-400")
        end
      end
      t.with_entry do |e|
        e.capture do
          e.concat e.time_tag(Time.zone.today - 100.days, class: "mb-1 text-sm font-normal leading-none text-gray-400 dark:text-gray-500")
          e.concat e.content_tag(:h3, Faker::Books::Lovecraft.tome, class: "text-lg font-semibold text-gray-900 dark:text-white")
          e.concat e.content_tag(:p, Faker::Books::Lovecraft.paragraph, class: "mb-4 text-base font-normal text-gray-500 dark:text-gray-400")
        end
      end

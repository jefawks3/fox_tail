...
const DEFAULT_CLASSES = "bg-gray-900 bg-opacity-50 dark:bg-opacity-80 fixed inset-0 z-30";

export default (controller: Controller, options: Options = {}) => {
    let backdrop: HTMLElement | undefined = undefined;

    const handleClick = (e: Event) => {
        controller.application.logDebugActivity("useBackdrop", "onBackdropClicked");

...
class Flowbite::Timeline::EntryComponent < Flowbite::BaseComponent
  renders_one :visual, types: {
    ...
    icon: {
      ...
      renders: lambda { |icon_or_options = {}, options = {}|
        ...
        render_icon(options) { |attributes| render Flowbite::IconBaseComponent.new(icon_or_options, attributes) }
      }
    },
    svg: {
      as: :svg,
      renders: lambda { |path, options = {}|
        render_icon(options) { |attributes| render Flowbite::InlineSvgComponent.new(path, attributes) }
      }
    },
    image: {
      as: :image,

...
export default class extends Controller {
    ...
    collapsibleTargetConnected(element: Element): void {
        ...
        element.addEventListener("flowbite--collapsible:show", this.handleShow, true);
    }

    collapsibleTargetDisconnected(element: Element): void {
        this._collapsibleItems.delete(element);
        element.removeEventListener("flowbite--collapsible:show", this.handleShow, true);
    }
    ...
    private getCollapsibleControllers(): CollapsibleController[] {
        ...
        this._collapsibleItems.forEach((controller, element) => {
            if (!controller) {
                controller = this.application.getControllerForElementAndIdentifier(element, "flowbite--collapsible") as CollapsibleController;

...
export default class TabController extends Controller {
    ...
    static outlets = ["flowbite--tab", "flowbite--collapsible"];
    ...
    declare readonly flowbiteTabOutlets: TabController[];
    declare readonly hasFlowbiteCollapsibleOutlet: boolean;
    ...
    flowbiteCollapsibleOutletConnected(outlet: CollapsibleController): void {
        if (this._selected) {
            outlet.show();
        } else {
            outlet.hide();
    ...
    select(): void {
        ...
        this.hasFlowbiteCollapsibleOutlet && this.flowbiteCollapsibleOutlet.show();
        this.onSelected();
    }
    ...
    deselect(): void {
        ...
        this.hasFlowbiteCollapsibleOutlet && this.flowbiteCollapsibleOutlet.hide();
        this.onDeselected();
    }
    ...
    private deselectSiblings(): void {
        this.flowbiteTabOutlets.forEach((tab) => {

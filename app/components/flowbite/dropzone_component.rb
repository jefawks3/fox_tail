...
class Flowbite::DropzoneComponent < Flowbite::BaseComponent
  ...
  renders_one :icon, lambda { |icon, attributes = {}|
    ...
    Flowbite::IconBaseComponent.new icon, attributes
  }
  ...
  def before_render
    ...
    with_title I18n.t("components.flowbite.dropzone.title_html").html_safe unless title?

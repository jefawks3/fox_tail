...
class Flowbite::ModalComponent < Flowbite::BaseComponent
  include Flowbite::Concerns::HasStimulusController

  renders_one :trigger, lambda { |options = {}|
    Flowbite::ModalTriggerComponent.new options.delete(:id), "##{tag_id}", options
  }
  ...
  def close_icon_button_component(icon_or_options = {}, options = {})
    ...
    component = Flowbite::IconButtonComponent.new options

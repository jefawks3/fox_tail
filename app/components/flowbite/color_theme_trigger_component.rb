...
class Flowbite::ColorThemeTriggerComponent < Flowbite::TriggerBaseComponent
  has_option :action
  ...
  class StimulusController < Flowbite::ViewComponents::StimulusController
    def attributes(options = {})
      ...
      controller_options.reverse_merge! Flowbite::ViewComponents::Base.flowbite_config.color_theme

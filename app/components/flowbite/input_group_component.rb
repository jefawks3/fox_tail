...
class Flowbite::InputGroupComponent < Flowbite::BaseComponent
  ...
  renders_many :items, types: {
    input: {
      ...
      renders: lambda { |method_or_options = {}, options = {}|
        ...
        Flowbite::InputComponent.new objectify_options(options)
      }
    },
    select: {
      as: :select,
      renders: lambda { |method_or_options = {}, options = {}|
        ...
        Flowbite::SelectComponent.new objectify_options(options) }
    },
    button: {
      as: :button,
      renders: lambda { |method_or_options = {}, options = {}|
        ...
        Flowbite::ButtonComponent.new objectify_options(options) }
    },
    icon_button: {
      as: :icon_button,
      renders: lambda { |icon_or_method, *args|
        ...
        Flowbite::IconButtonComponent.new icon, objectify_options(options)
      }
    },
    text: {
      as: :text,
    ...
    icon: {
      ...
      renders: lambda { |icon, options = {}|
        ...
        addon_component { render Flowbite::IconBaseComponent.new icon, options }
      }
    },
    svg: {
      as: :svg,
      renders: lambda { |path, options = {}|
        ...
        addon_component { render Flowbite::InlineSvgComponent.new(path, options) }
      }
    },
    image: {
      as: :image,
    ...
    wrapped: {
      as: :item,
      renders: lambda { |&block| Flowbite::WrapperComponent.new(&block) }
    }
  }
  ...
  def addon_component(options = {}, &block)
    Flowbite::WrapperComponent.new class: theme.apply(:addon, self, { fill: options[:fill] }) do |wrapper|

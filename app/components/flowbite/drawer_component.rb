...
class Flowbite::DrawerComponent < Flowbite::BaseComponent
    ...
    icon: {
      ...
      renders: lambda { |icon_or_options = {}, options = {}, icon_options = {}|
        ...
        content_tag :button, options do
          concat render(Flowbite::IconBaseComponent.new(icon_or_options, icon_options))
          concat content_tag(:span, I18n.t("flowbite.close"), class: theme.classname("accessibility.sr_only"))
        end
      }
    }
  }
